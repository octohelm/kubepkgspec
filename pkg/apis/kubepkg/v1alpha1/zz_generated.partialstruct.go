...
type DaemonSetSpec struct {
	...
	Selector *k8s_io_apimachinery_pkg_apis_meta_v1.LabelSelector `json:"selector" protobuf:"bytes,1,opt,name=selector"`
...
type DeploymentSpec struct {
	...
	// It must match the pod template's labels.
	Selector *k8s_io_apimachinery_pkg_apis_meta_v1.LabelSelector `json:"selector" protobuf:"bytes,2,opt,name=selector"`
...
type JobSpec struct {
	...
	// More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors
	Selector *k8s_io_apimachinery_pkg_apis_meta_v1.LabelSelector `json:"selector,omitempty" protobuf:"bytes,4,opt,name=selector"`
